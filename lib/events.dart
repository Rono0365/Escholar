...
appBar: TabBar(
            ...
            body: TabBarView(children: [
              //here most prolly for monday
               SingleChildScrollView(
                child: Column(
                  children:[...this.title1.map((i) => i['day_taught'] == "Monday"
                        ? Column(
    ...
    //bottoma navigation bar
                ...
                child: Column(
                  children:[...this.title1.map((i) => i['day_taught'] == "Tuesday"
                        ? Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Row(
    ...
    //bottoma navigation bar
                ...
                child: Column(
                  children:[...this.title1.map((i) => i['day_taught'] == "Wednesday"
                        ? Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Row(
    ...
    //bottoma navigation bar
                ...
                child: Column(
                  children:[...this.title1.map((i) => i['day_taught'] == "Thursday"
                        ? Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Row(
    ...
    //bottoma navigation bar
                ...
                child: Column(
                  children:[...this.title1.map((i) => i['day_taught'] == "Friday"
                        ? Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Row(
